...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:8080","http://localhost:5174","http://localhost:5173", "https://noteshare-production-b136.up.railway.app", "https://note-share-vert.vercel.app"));
